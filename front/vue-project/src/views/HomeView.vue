<template>
    <div>
      ...
      <div v-else>
        <ul>
            <li><a href="#" class="active">Home</a></li>
            <li><a href="/FinanceProduct">Finance Product</a></li>
            <!-- <li><a href="/exchangerate">ExchangeRate</a></li> -->
            
            <li><a href="/ex2">ExchangeRate 2</a></li>
    ...
    <!-- <section> -->
        ...
        <!-- <div> -->
        <!-- <img src="KBimg.png" id="mountains_behind"> -->
        <!-- <img src="uri.png" id="uri"> -->
    <!-- </div> -->
    <!-- <div> -->
        <!-- <img src="3.png" id="nh"> -->
        <!-- <img src="shinhan.png" id="shinhan"> -->
    <!-- </div> -->
        <!-- <img src="KBimg.png" id="mountains_behind"> -->
        <!-- <h2 id="text">Moon Light</h2> -->
        <!-- <a href="#sec" id="btn">Explore</a> -->
        <!-- <img src="KB.png" id="mountains_front"> -->
    ...
    <div v-if="language==='한국어'">
    <section>
      <img src="stars.png" id="stars" :style="{ left: starsLeft }">
      <img src="moon.png"  id="moon" :style="{ top: moonTop }">
      <div>
        <img src="KBimg.png" id="mountains_behind" :style="{ left: mountainsBehindLeft }">
        <img src="uri.png" id="uri" :style="{ right: uriRight }">
      </div>
      <div>
        <img src="3.png" id="nh" :style="{ left: nhLeft }">
      </div>
      <a href="#kakao" id="btn">지도 보기</a>
    </section>
    <div class="sec" id="sec">
        <h2>공지사항</h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Esse reiciendis amet aspernatur culpa assumenda, eligendi 
            modi illo est. Commodi voluptatem, accusantium omnis eos aspernatur
             odit deleniti impedit tempora aliquam nesciunt?<br><br>
             ...
             modi illo est. Commodi voluptatem, accusantium omnis eos aspernatur
              ...
              modi illo est. Commodi voluptatem, accusantium omnis eos aspernatur
               ...
               Esse reiciendis amet aspernatur culpa assumenda, eligendi 
               modi illo est. Commodi voluptatem, accusantium omnis eos aspernatur
                odit deleniti impedit tempora aliquam nesciunt?</p>
    </div>
  </div>
  <!-- 영어버전 -->
  <div v-else>
    <section>
      ...
      <img src="moon.png"  id="moon" :style="{ top: moonTop }">
      <div>
        <img src="englishkb.png" id="mountains_behind" :style="{ left: mountainsBehindLeft }">
        <img src="englishuri.png" id="uri" :style="{ right: uriRight }">
      </div>
      <div>
        <img src="englishnh.png" id="nh" :style="{ left: nhLeft }">
      </div>
      <a href="#kakao" id="btn">Map</a>
    </section>
    ...
    <div class="home-2">
      <!--랜덤알고리즘-->
      <!-- <div v-if="store.randomData">
        <div v-for="data in store.randomData">
      ...
      <div v-if="store.randomData2">
        <h1>추천상품</h1>
        <div v-for="datas in store.randomData2">
          <div v-for="data in datas">
            <!-- {{ data }} -->
            {{ data.product__kor_co_nm}}
            {{ data.product__fin_prdt_nm}}
        {{ data.intr_rate_type_nm }}
        {{ data.intr_rate }}
        {{ data.intr_rate2 }}
          </div>
        <!--  -->
  ...
  const pics =ref([
    {
      'pic': 'https://scontent-ssn1-1.xx.fbcdn.net/v/t1.6435-9/174206810_4024590510935430_3091853476947703323_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=300f58&_nc_ohc=FIiJG7YZ8hkAX_wFx4u&_nc_ht=scontent-ssn1-1.xx&oh=00_AfA36-tXunYOtkIB_kJF3XQ1jtgSPusFFDIGesySQC-HmA&oe=657D186A',
      
  
    },
    {
      'pic' : 'http://www.insidevina.com/news/photo/202307/24515_27416_2842.png',
      
    },
    {
      'pic' : 'https://cdn.apnews.kr/news/photo/202205/3002388_22677_5152.png',
  ...
  const homepics = ref('https://scontent-ssn1-1.xx.fbcdn.net/v/t1.6435-9/174206810_4024590510935430_3091853476947703323_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=300f58&_nc_ohc=FIiJG7YZ8hkAX_wFx4u&_nc_ht=scontent-ssn1-1.xx&oh=00_AfA36-tXunYOtkIB_kJF3XQ1jtgSPusFFDIGesySQC-HmA&oe=657D186A')
  let cn = 0
  const leftClicked = function(){
    
    if (cn===0){
      cn = pics.value.length-1
      homepics.value = cn
    }
    else {
      cn-=1
    ...
    homepics.value = pics.value[cn].pic
   
  }
  const rightClicked = function(){
    if (cn === pics.value.length-1){
      cn = 0
    }
    else {
      cn+=1
  ...
  let starsLeft = ref('0px');
  let moonTop = ref('0px');
  let mountainsBehindLeft = ref('0px');
  let uriRight = ref('0px');
  let nhLeft = ref('0px');
  let headerTop = ref('0px');
  window.addEventListener('scroll',function(){
    let value = window.scrollY;
    console.log(value)
    starsLeft.value = value * 0.25 + 'px';
    moonTop.value = value * 1.05 + 'px';
    mountainsBehindLeft.value = value * 3 + 'px';
    nhLeft.value = value * 3 + 'px';
    uriRight.value = value * 3 + 'px';
      shinhan.style.right = value*3 + 'px'
      // mountains_front.style.left = value*0 + 'px'
      // kb.style.marginRight = value*4 + 'px'
      // text.style.marginRight = value*4 + 'px'
      // text.style.marginTop = value*1.5 + 'px'
      btn.style.marginTop = value*1.5 + 'px'
      headerTop.style.top = value * 0.5 + 'px'
      // kb.style.left = value * 0.2 + 'px';
})
  window.scroll({
      behavior : 'smooth'
  })
...
/* #kb {
    position: absolute;
    left: 0; /* 초기 위치를 0으로 설정하거나 필요에 따라 조절하세요 */
    /* 그 외의 스타일 속성들... 
} */
